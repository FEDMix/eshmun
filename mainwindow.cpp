    ...
    mInteractorStyle(vtkSmartPointer<vtkInteractorStyle>::New())
{
    ...
    QObject::connect(ui->pushButton, &QPushButton::clicked, this, &MainWindow::onDrawSphereClick);
}
...
void MainWindow::onDrawSphereClick() {
    // Create sphere
    vtkSmartPointer<vtkSphereSource> sphereSource = vtkSmartPointer<vtkPSphereSource>::New();
